...
class Question(Updated):
    ...
    difficulty = models.IntegerField( choices = TYPE , default= 0  , verbose_name= _("Difficulty"))
    date_created = models.DateTimeField(auto_now_add=True , verbose_name= _("Date Created"))
    isActive =  models.BooleanField(default=False , verbose_name= _("Active Status"))
...
class Answer(Updated):
    ...
    category = models.ForeignKey( Question , related_name='answer', on_delete= models.DO_NOTHING)
